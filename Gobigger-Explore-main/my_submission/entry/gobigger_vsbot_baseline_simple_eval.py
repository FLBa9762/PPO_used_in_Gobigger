...
from policy.ppo_single_policy import PPOPolicy
from ding.utils import set_pkg_seed
from gobigger.agents import BotAgent

from envs import GoBiggerSimpleEnv
from model import GoBiggerPPoModel
...
def main(cfg, ckpt_path, seed=0):
    ...
    model = GoBiggerPPoModel(**cfg.policy.model)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt', '-c',
                        default='C:/Users/FLBa/Desktop/single_agent_revise/Gobigger-Explore-main/my_submission/entry/iteration_9000.pth.tar',
