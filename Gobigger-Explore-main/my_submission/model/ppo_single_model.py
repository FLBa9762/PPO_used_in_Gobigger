...
class GoBiggerLinear(nn.Module):
    ...
    def forward(self, encoder: torch.Tensor):
        ...
        x = F.relu(self.linear_q_1(encoder))
...
class GoBiggerPPoModel(nn.Module):
    ...
    def __init__(self,
        ...
        # self.critic_encoder = Encoder(scalar_shape = scalar_shape,
        #                                    food_shape = food_shape,
        #                                    food_relation_shape = food_relation_shape,
        #                                    thorn_relation_shape = thorn_relation_shape,
        #                                    clone_shape = clone_shape,
        ...
        self.critic_head = RegressionHead(critic_head_hidden_size, 1, critic_head_layer_num,
                                          activation=activation)
    ...
    def compute_actor(self, inputs: torch.Tensor):
        ...
        x = self.encoder(scalar, food, food_relation, thorn_relation, thorn_mask, clone,
    ...
    def compute_actor_critic(self, inputs:torch.Tensor):
        ...
        actor_embedding = critic_embedding = self.encoder(scalar, food, food_relation, thorn_relation,
                                                          thorn_mask, clone, clone_relation, clone_mask)
        # critic_embedding = self.encoder(scalar, food, food_relation, thorn_relation, thorn_mask, clone,
        #                                      clone_relation, clone_mask)
